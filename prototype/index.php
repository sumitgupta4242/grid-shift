    ...
    <header class="navbar-section">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="home.php"><i class="bi bi-chat"></i>Grid Gardians</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 text-content">
                    ...
                    <button class="btn"><a href="login.php">Estimate Project</a></button>
                </div>
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <img src="images/homeimage.jpg" alt="" class="img-fluid">
                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Inefficient solar energy usage wastes renewable resources. 
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Reduces energy bills, 
                                    Stabilizes the grid, and promotes sustainability.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Real-Time Monitoring: Track solar energy production via a user-friendly dashboard.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="about-section" id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 text-content">
                    <h3>who we are</h3>
                    <h1>Providing creative and technology services for energy sever.</h1>
                    ...
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Address</h3>
                                <p>greater noida,<br>Delhi NCR</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Call Us</h3>
                                <p>+91 8354944670<br>+91 8394910079</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
                                ...
                                <h3>Email Us</h3>
                                <p>2022498440.sumit@ug.sharda.ac.in<br></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <p class="logo"><i class="bi bi-chat"></i> Solar Sync</p>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <ul class="d-flex">
                        <li><a href="#">Home</a></li>
